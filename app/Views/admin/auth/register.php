...
<body class="bg-background-dark font-display text-white antialiased">
    ...
    <div class="content-overlay">
        <div class="split-layout flex min-h-screen">
                ...
                <div class="max-w-2xl text-center lg:text-left">
                    ...
                    <div class="space-y-6 mb-8">
                        <h2 class="text-4xl lg:text-5xl xl:text-6xl font-black leading-tight">
                            <span class="block">Bergabung</span>
                            <span class="block text-transparent bg-clip-text bg-gradient-to-r from-white to-[#A0A0A0]">Sekarang</span>
                        </h2>
            ...
            <div class="register-section flex-1 flex items-center justify-center p-8 lg:p-12 xl:p-16 min-h-screen">
                <div class="w-full max-w-md">
                    <div class="glassmorphism p-8 rounded-xl glassmorphism-hover transition-all duration-300">
                        ...
                        <div class="text-center mb-8">
                            ...
                            <p class="text-[#A0A0A0] mt-2">Daftar untuk mengelola portfolio</p>
                        </div>
                        ...
                        <form action="/admin/register" method="POST">
                            ...
                            <div class="space-y-4">
                                <div>
                                    <label for="username" class="block text-sm font-medium text-[#A0A0A0] mb-2">
                                    ...
                                    <input type="text" id="username" name="username" required 
                                           ...
                                           minlength="3">
                                    <p class="text-xs text-[#A0A0A0] mt-1 ml-1">Minimal 3 karakter</p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="password" id="password" name="password" required 
                                           ...
                                           minlength="6">
                                    <p class="text-xs text-[#A0A0A0] mt-1 ml-1">Minimal 6 karakter</p>
                                </div>

                                <div>
                                    <label for="password_confirm" class="block text-sm font-medium text-[#A0A0A0] mb-2">
                        ...
                        <div class="mt-6 text-center">
                            <p class="text-[#A0A0A0] text-sm">
                                Sudah punya akun? 
                                <a href="/admin/login" class="text-white hover:text-[#A0A0A0] font-medium transition-colors">
                                    Login di sini
                                </a>
                            </p>
                        </div>
    ...
    <script>
        ...
        if (registerForm) {
            registerForm.addEventListener('submit', function() {
                ...
                if (submitButton) {
                    submitButton.innerHTML = '<i class="fas fa-spinner fa-spin"></i><span class="truncate">Mendaftarkan...</span>';
